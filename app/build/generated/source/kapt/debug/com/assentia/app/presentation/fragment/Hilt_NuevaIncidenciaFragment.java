...
public abstract class Hilt_NuevaIncidenciaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NuevaIncidenciaFragment() {
    super();
  }

  Hilt_NuevaIncidenciaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NuevaIncidenciaFragment_GeneratedInjector) this.generatedComponent()).injectNuevaIncidenciaFragment(UnsafeCasts.<NuevaIncidenciaFragment>unsafeCast(this));
    }
  }
