...
public abstract class Hilt_DetalleVisitaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetalleVisitaFragment() {
    super();
  }

  Hilt_DetalleVisitaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetalleVisitaFragment_GeneratedInjector) this.generatedComponent()).injectDetalleVisitaFragment(UnsafeCasts.<DetalleVisitaFragment>unsafeCast(this));
    }
  }
