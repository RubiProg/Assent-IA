...
public abstract class Hilt_NuevoPacienteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NuevoPacienteFragment() {
    super();
  }

  Hilt_NuevoPacienteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NuevoPacienteFragment_GeneratedInjector) this.generatedComponent()).injectNuevoPacienteFragment(UnsafeCasts.<NuevoPacienteFragment>unsafeCast(this));
    }
  }
