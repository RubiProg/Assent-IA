...
public abstract class Hilt_FamiliarHomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FamiliarHomeFragment() {
    super();
  }

  Hilt_FamiliarHomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FamiliarHomeFragment_GeneratedInjector) this.generatedComponent()).injectFamiliarHomeFragment(UnsafeCasts.<FamiliarHomeFragment>unsafeCast(this));
    }
  }
