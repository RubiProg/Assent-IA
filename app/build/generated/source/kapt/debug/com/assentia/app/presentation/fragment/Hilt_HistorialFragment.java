...
public abstract class Hilt_HistorialFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HistorialFragment() {
    super();
  }

  Hilt_HistorialFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HistorialFragment_GeneratedInjector) this.generatedComponent()).injectHistorialFragment(UnsafeCasts.<HistorialFragment>unsafeCast(this));
    }
  }
