...
public abstract class Hilt_PacientesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PacientesFragment() {
    super();
  }

  Hilt_PacientesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PacientesFragment_GeneratedInjector) this.generatedComponent()).injectPacientesFragment(UnsafeCasts.<PacientesFragment>unsafeCast(this));
    }
  }
