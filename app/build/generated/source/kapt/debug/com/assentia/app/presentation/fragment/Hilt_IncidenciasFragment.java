...
public abstract class Hilt_IncidenciasFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IncidenciasFragment() {
    super();
  }

  Hilt_IncidenciasFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IncidenciasFragment_GeneratedInjector) this.generatedComponent()).injectIncidenciasFragment(UnsafeCasts.<IncidenciasFragment>unsafeCast(this));
    }
  }
