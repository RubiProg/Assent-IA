...
public abstract class Hilt_DetallePacienteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetallePacienteFragment() {
    super();
  }

  Hilt_DetallePacienteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetallePacienteFragment_GeneratedInjector) this.generatedComponent()).injectDetallePacienteFragment(UnsafeCasts.<DetallePacienteFragment>unsafeCast(this));
    }
  }
