...
public abstract class Hilt_AgendaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AgendaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AgendaFragment_GeneratedInjector) this.generatedComponent()).injectAgendaFragment(UnsafeCasts.<AgendaFragment>unsafeCast(this));
    }
  }
